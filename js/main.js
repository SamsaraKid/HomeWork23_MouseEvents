...
const coords = [
    {px0: 0, py0: 0, px: 0, py: 0, ofx: 0, ofy: 0},
    {px0: 0, py0: 0, px: 0, py: 0, ofx: 0, ofy: 0},
    {px0: 0, py0: 0, px: 0, py: 0, ofx: 0, ofy: 0}
]
...
function start(event){
    ...
    coords[id].ofx = event.offsetX
    coords[id].ofy = event.offsetY
}
...
function checkForEaten(id){
    ...
    let foodCenterX = coords[id].px-coords[id].ofx + 75
    let foodCenterY = coords[id].py-coords[id].ofy + 75
